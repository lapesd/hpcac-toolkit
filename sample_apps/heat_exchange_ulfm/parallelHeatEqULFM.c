...
#include <mpi.h>
#include <mpi-ext.h>
#include "parallelHeatEqULFM.h"


#define min(a, b) ((a) <= (b) ? (a) : (b))
#define CHECKPOINT_STEP 1000
...
int main(int argc, char *argv[]) {
    ...
    /* Variables for MPI error messaging configuration */
    static char errorString[MPI_MAX_ERROR_STRING]="";
    static int errorStringLength;
    ...
    while(!converged) {
        ...
        if ((result<epsilon) || (step>maxSteps)) break;
    }
